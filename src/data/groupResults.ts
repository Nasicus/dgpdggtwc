...
export const group3: Group = [
  ...
  [
    "Week 2",
    [
      ["AS Business Engineering", "Kassandra", ""],
      ["Bender & Fancy Bear!", "Rivendell", ""],
      ["Blofeld", "Ghostbusters", ""],
      ["Globefingers", "Funny Cats", ""],
      ["BREAK", "Skynet", ""],
    ],
  ],
  [
